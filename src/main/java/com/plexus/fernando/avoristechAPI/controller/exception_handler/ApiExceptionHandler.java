...
import com.plexus.fernando.avoristechAPI.persitence.exceptions.ConflictException;
import com.plexus.fernando.avoristechAPI.persitence.exceptions.NotFoundException;
...
public class ApiExceptionHandler {
    ...
    private ErrorResponse getErrorResponse(Exception ex, HttpStatus httpStatus) {
        ...
        return new ErrorResponse(httpCode,httpName,causeMessage,clazz,method,line);
    }
